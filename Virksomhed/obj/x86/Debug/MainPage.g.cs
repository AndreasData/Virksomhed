#pragma checksum "C:\Users\simon\OneDrive\Desktop\Skole\Software Construction\Kode\Virksomhed\Virksomhed\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "8FE77D44A2B8F493234F2B08250E6B23"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Virksomhed
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IMainPage_Bindings
        {
            ...
            {
                if (lineNumber == 28 && columnNumber == 54)
                {
            ...
            IMainPage_Bindings
        {
            ...
            private void Update_(global::Virksomhed.Virksomhed obj, int phase)
            {
                ...
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | DATA_CHANGED | (1 << 0))) != 0)
                    {
                        this.Update_VirksomhedsBrugernavn(obj.VirksomhedsBrugernavn, phase);
                        this.Update_VirksomhedsPassword(obj.VirksomhedsPassword, phase);
                        this.Update_VirksomhedsEmail(obj.VirksomhedsEmail, phase);
                    }
                }
            }
            private void Update_VirksomhedsBrugernavn(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
            ...
            private void Update_VirksomhedsPassword(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
            ...
            private void Update_VirksomhedsEmail(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
            ...
            private void UpdateTwoWay_18_Text()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        this.dataRoot.VirksomhedsBrugernavn = this.obj18.Text;
                    }
                }
            }
            private void UpdateTwoWay_19_Text()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        this.dataRoot.VirksomhedsPassword = this.obj19.Text;
                    }
                }
            }
            private void UpdateTwoWay_20_Text()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        this.dataRoot.VirksomhedsEmail = this.obj20.Text;
                    }
                }
            }
                ...
                public void PropertyChanged_(object sender, global::System.ComponentModel.PropertyChangedEventArgs e)
                {
                    ...
                    if (bindings != null)
                    {
                        ...
                        if (global::System.String.IsNullOrEmpty(propName))
                        {
                            if (obj != null)
                            {
                                bindings.Update_VirksomhedsBrugernavn(obj.VirksomhedsBrugernavn, DATA_CHANGED);
                                bindings.Update_VirksomhedsPassword(obj.VirksomhedsPassword, DATA_CHANGED);
                                bindings.Update_VirksomhedsEmail(obj.VirksomhedsEmail, DATA_CHANGED);
                            }
                        }
                        else
                        {
